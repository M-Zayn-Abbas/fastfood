...
class Wpc_Reservation_Report {
    ...
    public function reservation_report_filter_status_dropdown() {
        ...
        if ('wpc_reservation' === $post_type) {
            ...
            $meta_values = $wpdb->get_col($wpdb->prepare("SELECT DISTINCT meta_value FROM {$wpdb->postmeta} WHERE meta_key = %s", $meta_key));
                ...
                ?>
                    <select name="meta_filter">
                        ...
                        foreach ($meta_values as $value) {
                            $selected = (isset($_GET['meta_filter']) && $_GET['meta_filter'] === $value) ? 'selected' : '';
