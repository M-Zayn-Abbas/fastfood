...
abstract class Setting_field{
        ...
        ?>
            <div class="<?php echo esc_attr($class); ?>">
                <div class="wpc-label">
                    ...
                    <div class="wpc-desc"> <?php echo Utils::wpc_render($desc); ?>  </div>
                </div>
                <?php 
                if((isset($item['pro']) && !class_exists( 'Wpcafe_Pro' ))){ 
                    ...
                    <div class="wpc-meta">
                        ...
                        <?php echo Utils::wpc_render($span . $eye_html); ?>
                    </div>
                    <?php
                }
                ?>
    ...
    public function get_number_input( $item, $key, $data ) {
        ...
        echo \WpCafe\Utils\Wpc_Utilities::wpc_render($html);    
    }
    ...
    public function get_select_single( $item, $key, $data ) {
        ...
        <div class="<?php echo esc_attr($class); ?>" style="<?php echo esc_attr($style); ?>"> 
            <div class="wpc-label"> 
                    ...
                    <div class="wpc-desc">
                        <?php echo Utils::wpc_render($item['desc']); ?> 
                    </div>
            </div>
            <?php 
                if((isset($item['pro']) && !class_exists( 'Wpcafe_Pro' ))){ 
                    ...
                    ?>
                    <div class="wpc-meta">
                        <?php echo Utils::wpc_render($input); ?>
                        <?php echo Utils::wpc_render($div_wrap); ?>
                    </div>
                    <?php
                }
            ?>
