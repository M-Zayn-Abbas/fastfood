        ...
        <div class="wpc-tab" data-id="schedule-reservation-settings">
            ...
            <div class="wpc-label-item wpc-schedule-tab">
                ...
                <div class="wpc-label wpc-schedule-label">
                    <strong class="wpc-settings-label"><?php esc_html_e('Schedule', 'wpcafe'); ?></strong>
                                            ...
                                            <div class="schedule_block week_schedule_wrap week_schedule_wrap_<?php echo esc_attr( $index ); ?>" data-id="<?php echo esc_attr( $index ); ?>">
                                                ...
                                                <div class="schedule_block wpc-schedule-field">
                                                    ...
                                                    <div class="wpc_weekly_end_wrap">
                                                        <input type="text" name="wpc_weekly_schedule_end_time[]"   id="wpc_weekly_schedule_end_time_<?php echo intval($index) ?>" value="<?php echo Wpc_Utilities::wpc_render( $weekly_end_time ); ?>" class="wpc_weekly_schedule_end_time wpc_weekly_schedule_end_time_<?php echo Wpc_Utilities::wpc_numeric($index) ?> ml-2 wpc-settings-input attr-form-control <?php echo empty( $weekly_end_time ) ? 'wpc_field_error' : '' ?>" id="<?php echo intval($index);?>" placeholder="<?php echo esc_attr__('End Time', 'wpcafe'); ?>"/>
                                    ...
                                    ?>
                                        <div class="schedule_block week_schedule_wrap week_schedule_wrap_0" data-id="<?php echo esc_attr( 0 )?>">
                                            ...
                                            <div class="wpc-schedule-field">
                                                <div class="wpc_weekly_start_wrap">
                                                    <input type="text" name="wpc_weekly_schedule_start_time[]" id="weekly_start_0" class="wpc_weekly_schedule_start_time wpc_weekly_schedule_start_time_0 mr-1 wpc-settings-input attr-form-control" disabled placeholder="<?php echo esc_attr__('Start Time', 'wpcafe'); ?>"/>
                                                </div>
                                                <div class="wpc_weekly_end_wrap">
                                                    <input type="text" name="wpc_weekly_schedule_end_time[]" id="weekly_end_0" class="wpc_weekly_schedule_end_time wpc_weekly_schedule_end_time_0 wpc-settings-input attr-form-control" disabled placeholder="<?php echo esc_attr__('End Time', 'wpcafe'); ?>"/>
                                                </div>
            ...
            <div class="wpc-label-item wpc-shcedule-event-item">
                <div class="wpc-label">
                    <strong><?php esc_html_e('Exception Schedule', 'wpcafe'); ?></strong>
                    ...
                    <div class="exception_main_block">
                            ...
                            for ( $index=0; $index < count( $wpc_exception['wpc_exception_date'] ) ; $index ++) {
                                ...
                                <div class="exception_block d-flex mb-2">
                                    ...
                                    <div class="wpc_exception_start_time_wrap">
                                        <input type="text" name="wpc_exception_start_time[]" value="<?php echo Wpc_Utilities::wpc_render( $exception_start_time ); ?>" class="wpc_exception_start_time wpc_exception_start_time_<?php echo intval( $index )?> mr-1 wpc-settings-input attr-form-control <?php echo empty( $exception_start_time ) ? 'wpc_field_error' : '' ?>" id="exception_start_time<?php echo intval( $index ) ?>"  placeholder="<?php esc_attr_e('Start Time', 'wpcafe'); ?>" />
                                        <?php if( empty( $exception_start_time ) ) { ?>
                                            <span class="wpc_field_error_msg"><?php echo esc_html__('This field should be filled up', 'wpcafe'); ?></span>
                                        <?php } ?>
                                    </div>
                                    <div class="wpc_exception_end_time_wrap">
                                        <input type="text"  name="wpc_exception_end_time[]" value="<?php echo Wpc_Utilities::wpc_render( $exception_end_time ); ?>" class="wpc_exception_end_time wpc_exception_end_time_<?php echo intval( $index )?> wpc-settings-input attr-form-control <?php echo empty( $exception_end_time ) ? 'wpc_field_error' : '' ?>" id="exception_end_time<?php echo intval( $index ) ?>"  placeholder="<?php esc_attr_e('End Time', 'wpcafe' ); ?>"/>
                        ...
                        ?>
                            <div class="exception_block d-flex mb-2">
                                ...
                                <div class="wpc_exception_start_time_wrap">
                                    <input type="text" name="wpc_exception_start_time[]" value="" id="wpc_exception_start_time_0" class="wpc_exception_start_time wpc_exception_start_time_0 mr-1 wpc-settings-input attr-form-control" disabled placeholder="<?php esc_attr_e('Start Time', 'wpcafe'); ?>" />
                                </div>
                                <div class="wpc_exception_end_time_wrap">
                                    <input type="text" name="wpc_exception_end_time[]" value="" id="wpc_exception_end_time_0" class="wpc_exception_end_time wpc_exception_end_time_0 wpc-settings-input attr-form-control" disabled placeholder="<?php esc_attr_e('End Time', 'wpcafe'); ?>"/>
                                </div>
                ...
                $markup_fields_five = [
                    ...
                    'wpc_admin_booking_confirm_email' => [
                        'item' => [
                            ...
                            'type'     => 'wp_editor',
                            'attr'     => ['class' => 'wpc-label-item rich-texteditor'],
                            'settings' => ['textarea_name'=> 'wpc_admin_booking_confirm_email', 
                            'media_buttons' => false, 'wpautop' => true],
                            'pro'   => 'yes'
                        ],
                    ...
                    'wpc_confirm_email' => [
                        'item' => [
                            ...
                            'type'     => 'wp_editor',
                            'attr'     => ['class' => 'wpc-label-item rich-texteditor'],
                            'settings' => ['textarea_name'=> 'wpc_confirm_email',
                            'media_buttons' => false, 'wpautop' => true],
                            'pro'   => 'yes'
                        ],
